        ...
        <div className="settings-body">
          ...
          <main>
            {page === 'general' && <>
              ...
              <Toggle label="Confirm workspace URL on new tabs" detail="Switching briefly previews the workspace URL, then returns to the base URL. Click the selected workspace to keep its specific URL." checked={settings.general?.holdBaseUrlUntilWorkspaceConfirmed === true} onChange={(value) => onPatch({ general: { holdBaseUrlUntilWorkspaceConfirmed: value } })} />
